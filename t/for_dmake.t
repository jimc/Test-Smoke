...
SKIP: {
    ...
    # This should be set
    like( $makefile, qr/^INST_DRV\s*\*=\s*C:\n/m , '$(INST_DRV)' );
    like( $makefile, qr/^INST_DRV\t\*?= untuched\n/m, 
          "\$(INST_DRV) Untuched 1" );
    like( $makefile, qr/^INST_VER\s*\*=\s*\\5\.9\.0\n/m, 
          "\$(INST_VER)" );
    like( $makefile, qr/^#INST_ARCH\s*\*=/m, "#\$(INST_ARCH)" );
...
SKIP: {
    ...
    #These should be set
    like( $makefile, qr/^USE_GCC_V3_2\s*\*= define\n/m, 
          '$(USE_GCC_V3_2) set' );
}
...
SKIP: {
    ...
    # This should now be set 4 times
    like( $makefile, qr/^CCTYPE\s*\*=\ BORLAND\n
                         CCTYPE\s*\*=\ BORLAND\n
                         CCTYPE\s*\*=\ BORLAND\n
                         CCTYPE\s*\*=\ BORLAND\n
                     /mx, '$(CCTYPE) set 4 times' );
    ...
    #These should be set
    like( $makefile, qr/^BCCOLD\s*\*= define\n/m, 
          '$(BCCOLD) set' );
}
